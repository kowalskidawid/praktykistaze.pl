...
<div class="max-w-screen-xl mx-auto p-4">
    <div class="bg-white rounded-lg p-4 shadow-sm">
        ...
        <form id="searchForm" role="form" action="{{ route('companies.index') }}" method="GET">
            ...
            <div class="w-full flex items-center justify-between">
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex flex-col ml-4">
                        <a href="{{ route('companies.show', ['company' => $company]) }}" class="font-semibold text-lg">{{ Str::limit($company->company_name) }}</a>
                        <div class="flex items-center mt-1">
                            ...
                            <p class="ml-1 text-sm text-red-400 font-semibold">{{ $company->city }}</p>
                        </div>
                    </div>
                </div>
                {{-- Right --}}
