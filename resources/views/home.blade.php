...
<div class="w-full py-32 bg-indigo-600 mb-6 flex items-center">
    <div class="w-full max-w-screen-xl mx-auto p-4">
        ...
        <a href="{{route('register')}}" class="mt-6 flex w-44 justify-center items-center h-12 rounded-lg px-5 bg-indigo-100 text-black font-semibold hover:bg-purple-200">Załóż konto</a>
    </div>
</div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="flex flex-col ml-4">
                            ...
                            <div class="flex items-center mt-1">
                                ...
                                <p class="ml-1 text-sm text-red-400 font-semibold">{{ $offer->company->city }}, {{ $offer->company->location->name }}</p>
                            </div>
                        </div>
                    </div>
                    {{-- Offer position --}}
