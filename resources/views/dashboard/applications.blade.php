...
<div class="flex flex-col space-y-2">
    <div class="border-b border-gray-200 py-2">
        <h1 class="text-xl font-semibold">{{ __('Your applications')}}</h1>
    </div>
    <div class="py-4 flex flex-col space-y-4">
        ...
        <div class="p-4 bg-white border-gray-200 border rounded-lg flex items-center justify-between transition hover:shadow-lg">
            ...
            <div>
                <span class="text-xs uppercase font-semibold px-2 py-1 border border-blue-500 rounded text-blue-600">{{ __('Applied')}}</span>
            </div>
        </div>
        @endforeach
    </div>
