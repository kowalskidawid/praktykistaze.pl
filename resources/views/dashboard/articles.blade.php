...
<div class="flex flex-col space-y-2">
    <div class="border-b border-gray-200 py-2 flex items-center justify-between">
        <h1 class="text-xl font-semibold">{{ __('Articles')}}</h1>
        <a href="{{ route('dashboard.articlesCreate') }}" class="px-4 py-1 text-sm font-medium text-gray-900 border bg-white border-gray-200 rounded-lg hover:bg-gray-100">{{ __('Add article')}}</a>
    </div>
