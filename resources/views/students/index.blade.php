...
<div class="flex justify-between items-center p-4">
    <h1 class="font-bold text-2xl">Znajdź praktykanta</h1>
...
<div id="filter" class="border-b border-gray-200 p-4 pt-0 shadow-md mb-4" style="display: none;">
    <form class="flex flex-col space-y-4" id="searchForm" role="form" action="{{ route('students.index') }}" method="GET">
...
<div class="p-4 flex flex-col space-y-4">
    ...
    <a href="{{ route('students.show', ['student' => $student]) }}" class="p-4 bg-white rounded-2xl border-2 border-gray-100 shadow-lg flex space-x-4 items-center">
        ...
        <div>
            ...
            <p class="text-sm">{{ $student->city }}</p>
        </div>
    </a>
    @endforeach
    <div class="py-4">
